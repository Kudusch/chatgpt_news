...
Based on the leaning of these 22 media outlets, we calculated the mean political leaning of the references provided by ChatGPT. The results are displayed in @tbl-media-leaning. The political leaning of the sources used by ChatGPT does neither differ significantly from the average media leaning of the audience nor the center of the scale (= 4).
However, it is important to note that these 22 outlets comprise of just a fraction of both the number of unique domains and of all references provided by ChatGPT. Precisely, these 22 outlets account for `r round(share_leaning$share[1]*100,2)` percent of all references in the regular and `r round(share_leaning$share[2]*100,2)` percent of of all references in the diverse condition. 
